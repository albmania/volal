...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'SZnSbYtPxgD43REc', // Random key for encryption
    ...
    "USER_TABLE_NAME" => "perdoruesit",
    "LOGIN_USERNAME_FIELD_NAME" => "perdUsername",
    "LOGIN_PASSWORD_FIELD_NAME" => "perdFjalekalimi",
    "USER_ID_FIELD_NAME" => "perdID",
    "PARENT_USER_ID_FIELD_NAME" => "",
    "USER_LEVEL_FIELD_NAME" => "perdNiveliPerdoruesit",
    "USER_PROFILE_FIELD_NAME" => "perdProfileField",
    "REGISTER_ACTIVATE_FIELD_NAME" => "perdActivated",
    "USER_EMAIL_FIELD_NAME" => "perdEmail",
    ...
    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "`perdoruesit`",
    "USER_NAME_FILTER" => "(`perdUsername` = '%u')",
    "USER_ID_FILTER" => "(`perdID` = %u)",
    "USER_EMAIL_FILTER" => "(`perdEmail` = '%e')",
    ...
    "USER_PROFILE_SESSION_TIMEOUT" => 60,
    ...
    "UPLOAD_DEST_PATH" => "/ngarkime/", // Upload destination path (relative to app root)
