 ...
 * Page class
 */
class MenuDytesoreView extends MenuDytesore
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuDytesoreView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("menudID") ?? Route("menudID")) !== null) {
                ...
                $this->RecKey["menudID"] = $this->menudID->QueryStringValue;
            } elseif (Post("menudID") !== null) {
                $this->menudID->setFormValue(Post("menudID"));
                $this->RecKey["menudID"] = $this->menudID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->menudID->setQueryStringValue($keyValue);
                $this->RecKey["menudID"] = $this->menudID->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "MenuDytesoreList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "MenuDytesoreList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "MenuDytesoreList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
