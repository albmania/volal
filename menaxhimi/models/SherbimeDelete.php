 ...
 * Page class
 */
class SherbimeDelete extends Sherbime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SherbimeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SherbimeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SherbimeList"); // Return to list
                return;
            }
        }
