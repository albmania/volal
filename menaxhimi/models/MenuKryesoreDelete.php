 ...
 * Page class
 */
class MenuKryesoreDelete extends MenuKryesore
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuKryesoreDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MenuKryesoreList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MenuKryesoreList"); // Return to list
                return;
            }
        }
