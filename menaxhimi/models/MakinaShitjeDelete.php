 ...
 * Page class
 */
class MakinaShitjeDelete extends MakinaShitje
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MakinaShitjeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MakinaShitjeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MakinaShitjeList"); // Return to list
                return;
            }
        }
