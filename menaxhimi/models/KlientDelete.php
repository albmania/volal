 ...
 * Page class
 */
class KlientDelete extends Klient
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KlientDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KlientList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KlientList"); // Return to list
                return;
            }
        }
