 ...
 * Page class
 */
class ServisSherbimeGrid extends ServisSherbime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServisSherbimeGrid";
    ...
    public $FormName = "fservis_sherbimegrid";
    ...
    {
        $this->servisSherbimCmimi->FormValue = ""; // Clear form value
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->servisSherbimID->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_servisSherbimServisID") && $CurrentForm->hasValue("o_servisSherbimServisID") && $this->servisSherbimServisID->CurrentValue != $this->servisSherbimServisID->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_servisSherbimSherbimi") && $CurrentForm->hasValue("o_servisSherbimSherbimi") && $this->servisSherbimSherbimi->CurrentValue != $this->servisSherbimSherbimi->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_servisSherbimCmimi") && $CurrentForm->hasValue("o_servisSherbimCmimi") && $this->servisSherbimCmimi->CurrentValue != $this->servisSherbimCmimi->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_servisSherbimShenim") && $CurrentForm->hasValue("o_servisSherbimShenim") && $this->servisSherbimShenim->CurrentValue != $this->servisSherbimShenim->DefaultValue) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->servisSherbimID->clearErrorMessage();
        $this->servisSherbimServisID->clearErrorMessage();
        $this->servisSherbimSherbimi->clearErrorMessage();
        $this->servisSherbimCmimi->clearErrorMessage();
        $this->servisSherbimShenim->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->servisSherbimID->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
        ...
        if ($CurrentForm->hasValue("o_servisSherbimServisID")) {
            $this->servisSherbimServisID->setOldValue($CurrentForm->getValue("o_servisSherbimServisID"));
        }
        ...
        if ($CurrentForm->hasValue("o_servisSherbimSherbimi")) {
            $this->servisSherbimSherbimi->setOldValue($CurrentForm->getValue("o_servisSherbimSherbimi"));
        }
        ...
        if ($CurrentForm->hasValue("o_servisSherbimCmimi")) {
            $this->servisSherbimCmimi->setOldValue($CurrentForm->getValue("o_servisSherbimCmimi"));
        }
        ...
        if ($CurrentForm->hasValue("o_servisSherbimShenim")) {
            $this->servisSherbimShenim->setOldValue($CurrentForm->getValue("o_servisSherbimShenim"));
        }
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->servisSherbimServisID->getSessionValue() != "") {
                ...
                $this->servisSherbimServisID->OldValue = $this->servisSherbimServisID->CurrentValue;
                $this->servisSherbimServisID->ViewValue = $this->servisSherbimServisID->CurrentValue;
                $this->servisSherbimServisID->ViewValue = FormatNumber($this->servisSherbimServisID->ViewValue, $this->servisSherbimServisID->formatPattern());
                $this->servisSherbimServisID->ViewCustomAttributes = "";
            } else {
                ...
                if (strval($this->servisSherbimServisID->EditValue) != "" && is_numeric($this->servisSherbimServisID->EditValue)) {
                    ...
                    $this->servisSherbimServisID->OldValue = $this->servisSherbimServisID->EditValue;
                }
            }
            ...
            if (strval($this->servisSherbimCmimi->EditValue) != "" && is_numeric($this->servisSherbimCmimi->EditValue)) {
                ...
                $this->servisSherbimCmimi->OldValue = $this->servisSherbimCmimi->EditValue;
            }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "servis") {
            $this->servisSherbimServisID->CurrentValue = $this->servisSherbimServisID->getSessionValue();
        }
        ...
        // servisSherbimServisID
        $this->servisSherbimServisID->setDbValueDef($rsnew, $this->servisSherbimServisID->CurrentValue, 0, false);

        // servisSherbimSherbimi
        $this->servisSherbimSherbimi->setDbValueDef($rsnew, $this->servisSherbimSherbimi->CurrentValue, 0, false);

        // servisSherbimCmimi
        $this->servisSherbimCmimi->setDbValueDef($rsnew, $this->servisSherbimCmimi->CurrentValue, 0, false);

        // servisSherbimShenim
        $this->servisSherbimShenim->setDbValueDef($rsnew, $this->servisSherbimShenim->CurrentValue, null, false);

        // Update current values
        $this->setCurrentValues($rsnew);

        // Check referential integrity for master table 'servis_sherbime'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["servisSherbimServisID"] = $this->servisSherbimServisID->CurrentValue;
        $masterTable = Container("servis");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "servis") {
            $masterTbl = Container("servis");
            $this->servisSherbimServisID->Visible = false;
