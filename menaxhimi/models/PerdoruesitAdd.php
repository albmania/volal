 ...
 * Page class
 */
class PerdoruesitAdd extends Perdoruesit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerdoruesitAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PerdoruesitView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // perdNiveliPerdoruesit
        if ($Security->canAdmin()) { // System admin
            $this->perdNiveliPerdoruesit->setDbValueDef($rsnew, $this->perdNiveliPerdoruesit->CurrentValue, 0, strval($this->perdNiveliPerdoruesit->CurrentValue ?? "") == "");
        }

        // perdDtReg
        $this->perdDtReg->setDbValueDef($rsnew, UnFormatDateTime($this->perdDtReg->CurrentValue, $this->perdDtReg->formatPattern()), CurrentDate(), false);

        // perdActivated
        $this->perdActivated->setDbValueDef($rsnew, $this->perdActivated->CurrentValue, "", strval($this->perdActivated->CurrentValue ?? "") == "");

        // perdProfileField
        $this->perdProfileField->setDbValueDef($rsnew, $this->perdProfileField->CurrentValue, "", false);
