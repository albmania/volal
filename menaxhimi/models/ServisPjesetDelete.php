 ...
 * Page class
 */
class ServisPjesetDelete extends ServisPjeset
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServisPjesetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServisPjesetList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ServisPjesetList"); // Return to list
                return;
            }
        }
