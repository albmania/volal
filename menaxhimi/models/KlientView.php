 ...
 * Page class
 */
class KlientView extends Klient
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("klientID") ?? Route("klientID")) !== null) {
                ...
                $this->RecKey["klientID"] = $this->klientID->QueryStringValue;
            } elseif (Post("klientID") !== null) {
                $this->klientID->setFormValue(Post("klientID"));
                $this->RecKey["klientID"] = $this->klientID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->klientID->setQueryStringValue($keyValue);
                $this->RecKey["klientID"] = $this->klientID->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "KlientList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "KlientList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "KlientList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
