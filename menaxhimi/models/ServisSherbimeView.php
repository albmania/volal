 ...
 * Page class
 */
class ServisSherbimeView extends ServisSherbime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServisSherbimeView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("servisSherbimID") ?? Route("servisSherbimID")) !== null) {
            $this->RecKey["servisSherbimID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("servisSherbimID") ?? Route("servisSherbimID")) !== null) {
                ...
                $this->RecKey["servisSherbimID"] = $this->servisSherbimID->QueryStringValue;
            } elseif (Post("servisSherbimID") !== null) {
                $this->servisSherbimID->setFormValue(Post("servisSherbimID"));
                $this->RecKey["servisSherbimID"] = $this->servisSherbimID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->servisSherbimID->setQueryStringValue($keyValue);
                $this->RecKey["servisSherbimID"] = $this->servisSherbimID->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "ServisSherbimeList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "ServisSherbimeList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "ServisSherbimeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
