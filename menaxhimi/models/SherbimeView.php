 ...
 * Page class
 */
class SherbimeView extends Sherbime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SherbimeView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("sherbimeID") ?? Route("sherbimeID")) !== null) {
            $this->RecKey["sherbimeID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("sherbimeID") ?? Route("sherbimeID")) !== null) {
                ...
                $this->RecKey["sherbimeID"] = $this->sherbimeID->QueryStringValue;
            } elseif (Post("sherbimeID") !== null) {
                $this->sherbimeID->setFormValue(Post("sherbimeID"));
                $this->RecKey["sherbimeID"] = $this->sherbimeID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->sherbimeID->setQueryStringValue($keyValue);
                $this->RecKey["sherbimeID"] = $this->sherbimeID->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "SherbimeList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "SherbimeList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "SherbimeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
