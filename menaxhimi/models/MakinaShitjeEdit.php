 ...
 * Page class
 */
class MakinaShitjeEdit extends MakinaShitje
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MakinaShitjeEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("mshitjeID") ?? Key(0) ?? Route(2)) !== null) {
                $this->mshitjeID->setQueryStringValue($keyValue);
                $this->mshitjeID->setOldValue($this->mshitjeID->QueryStringValue);
            } elseif (Post("mshitjeID") !== null) {
                $this->mshitjeID->setFormValue(Post("mshitjeID"));
                $this->mshitjeID->setOldValue($this->mshitjeID->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("mshitjeID") ?? Route("mshitjeID")) !== null) {
                    ...
                    $this->mshitjeID->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->mshitjeID->IsDetailKey) {
            $this->mshitjeID->setFormValue($val);
        }
        ...
        // Check field name 'mshitjeAzhornuar' first before field var 'x_mshitjeAzhornuar'
        $val = $CurrentForm->hasValue("mshitjeAzhornuar") ? $CurrentForm->getValue("mshitjeAzhornuar") : $CurrentForm->getValue("x_mshitjeAzhornuar");
        if (!$this->mshitjeAzhornuar->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->mshitjeAzhornuar->Visible = false; // Disable update for API request
            } else {
                $this->mshitjeAzhornuar->setFormValue($val);
            }
            $this->mshitjeAzhornuar->CurrentValue = UnFormatDateTime($this->mshitjeAzhornuar->CurrentValue, $this->mshitjeAzhornuar->formatPattern());
        }
		$this->mshitjeFotografi->OldUploadPath = '../ngarkime/makina/';
		$this->mshitjeFotografi->UploadPath = $this->mshitjeFotografi->OldUploadPath;
    ...
    {
        global $CurrentForm;
        $this->mshitjeID->CurrentValue = $this->mshitjeID->FormValue;
        ...
        $this->mshitjeAzhornuar->CurrentValue = $this->mshitjeAzhornuar->FormValue;
        $this->mshitjeAzhornuar->CurrentValue = UnFormatDateTime($this->mshitjeAzhornuar->CurrentValue, $this->mshitjeAzhornuar->formatPattern());
    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
        if ($this->mshitjeID->Required) {
            if (!$this->mshitjeID->IsDetailKey && EmptyValue($this->mshitjeID->FormValue)) {
                $this->mshitjeID->addErrorMessage(str_replace("%s", $this->mshitjeID->caption(), $this->mshitjeID->RequiredErrorMessage));
            }
        }
        ...
        if ($this->mshitjeAzhornuar->Required) {
            if (!$this->mshitjeAzhornuar->IsDetailKey && EmptyValue($this->mshitjeAzhornuar->FormValue)) {
                $this->mshitjeAzhornuar->addErrorMessage(str_replace("%s", $this->mshitjeAzhornuar->caption(), $this->mshitjeAzhornuar->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        // mshitjeMarka
        $this->mshitjeMarka->setDbValueDef($rsnew, $this->mshitjeMarka->CurrentValue, 0, $this->mshitjeMarka->ReadOnly);

        // mshitjeModeli
        $this->mshitjeModeli->setDbValueDef($rsnew, $this->mshitjeModeli->CurrentValue, 0, $this->mshitjeModeli->ReadOnly);

        // mshitjeTipi
        $this->mshitjeTipi->setDbValueDef($rsnew, $this->mshitjeTipi->CurrentValue, 0, $this->mshitjeTipi->ReadOnly);

        // mshitjeStruktura
        $this->mshitjeStruktura->setDbValueDef($rsnew, $this->mshitjeStruktura->CurrentValue, "", $this->mshitjeStruktura->ReadOnly);

        // mshitjeKapacitetiMotorrit
        $this->mshitjeKapacitetiMotorrit->setDbValueDef($rsnew, $this->mshitjeKapacitetiMotorrit->CurrentValue, "", $this->mshitjeKapacitetiMotorrit->ReadOnly);

        // mshitjeVitiProdhimit
        $this->mshitjeVitiProdhimit->setDbValueDef($rsnew, $this->mshitjeVitiProdhimit->CurrentValue, 0, $this->mshitjeVitiProdhimit->ReadOnly);

        // mshitjeKarburant
        $this->mshitjeKarburant->setDbValueDef($rsnew, $this->mshitjeKarburant->CurrentValue, "", $this->mshitjeKarburant->ReadOnly);

        // mshitjeNgjyra
        $this->mshitjeNgjyra->setDbValueDef($rsnew, $this->mshitjeNgjyra->CurrentValue, "", $this->mshitjeNgjyra->ReadOnly);

        // mshitjeNrVendeve
        $this->mshitjeNrVendeve->setDbValueDef($rsnew, $this->mshitjeNrVendeve->CurrentValue, "", $this->mshitjeNrVendeve->ReadOnly);

        // mshitjeKambio
        $this->mshitjeKambio->setDbValueDef($rsnew, $this->mshitjeKambio->CurrentValue, "", $this->mshitjeKambio->ReadOnly);

        // mshitjePrejardhja
        $this->mshitjePrejardhja->setDbValueDef($rsnew, $this->mshitjePrejardhja->CurrentValue, "", $this->mshitjePrejardhja->ReadOnly);

        // mshitjeTargaAL
        $this->mshitjeTargaAL->setDbValueDef($rsnew, $this->mshitjeTargaAL->CurrentValue, "", $this->mshitjeTargaAL->ReadOnly);

        // mshitjeKilometra
        $this->mshitjeKilometra->setDbValueDef($rsnew, $this->mshitjeKilometra->CurrentValue, 0, $this->mshitjeKilometra->ReadOnly);

        // mshitjeFotografi
        if ($this->mshitjeFotografi->Visible && !$this->mshitjeFotografi->ReadOnly && !$this->mshitjeFotografi->Upload->KeepFile) {
            $this->mshitjeFotografi->Upload->DbValue = $rsold['mshitjeFotografi']; // Get original value
        ...
        // mshitjePershkrimi
        $this->mshitjePershkrimi->setDbValueDef($rsnew, $this->mshitjePershkrimi->CurrentValue, "", $this->mshitjePershkrimi->ReadOnly);

        // mshitjeCmimi
        $this->mshitjeCmimi->setDbValueDef($rsnew, $this->mshitjeCmimi->CurrentValue, "", $this->mshitjeCmimi->ReadOnly);

        // mshitjeIndex
        $this->mshitjeIndex->setDbValueDef($rsnew, $this->mshitjeIndex->CurrentValue, "", $this->mshitjeIndex->ReadOnly);

        // mshitjePromo
        $this->mshitjePromo->setDbValueDef($rsnew, $this->mshitjePromo->CurrentValue, "", $this->mshitjePromo->ReadOnly);

        // mshitjeAktiv
        $this->mshitjeAktiv->setDbValueDef($rsnew, $this->mshitjeAktiv->CurrentValue, "", $this->mshitjeAktiv->ReadOnly);

        // mshitjeShitur
        $this->mshitjeShitur->setDbValueDef($rsnew, $this->mshitjeShitur->CurrentValue, "", $this->mshitjeShitur->ReadOnly);
        ...
        // mshitjeAzhornuar
        $this->mshitjeAzhornuar->CurrentValue = CurrentDateTime();
        $this->mshitjeAzhornuar->setDbValueDef($rsnew, $this->mshitjeAzhornuar->CurrentValue, null);
        ...
        if ($this->mshitjeFotografi->Visible && !$this->mshitjeFotografi->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->mshitjeFotografi->Upload->FileName)) {
                ...
                $this->mshitjeFotografi->setDbValueDef($rsnew, $this->mshitjeFotografi->Upload->FileName, "", $this->mshitjeFotografi->ReadOnly);
            }
        }
