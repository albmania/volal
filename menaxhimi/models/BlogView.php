    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("blogID") ?? Route("blogID")) !== null) {
                ...
                $returnUrl = "BlogList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "BlogList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "BlogList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
