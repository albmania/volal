 ...
 * Page class
 */
class MenuDytesoreList extends MenuDytesore
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuDytesoreList";
    ...
    public $FormName = "fmenu_dytesorelist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "MenuDytesoreAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MenuDytesoreDelete";
        $this->MultiUpdateUrl = "MenuDytesoreUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fmenu_dytesoresrch");
        }
        $filterList = Concat($filterList, $this->menudID->AdvancedSearch->toJson(), ","); // Field menudID
        $filterList = Concat($filterList, $this->menudGjuha->AdvancedSearch->toJson(), ","); // Field menudGjuha
        $filterList = Concat($filterList, $this->menudKryesore->AdvancedSearch->toJson(), ","); // Field menudKryesore
        $filterList = Concat($filterList, $this->menudTitulli->AdvancedSearch->toJson(), ","); // Field menudTitulli
        $filterList = Concat($filterList, $this->menudUrl->AdvancedSearch->toJson(), ","); // Field menudUrl
        $filterList = Concat($filterList, $this->menudBlank->AdvancedSearch->toJson(), ","); // Field menudBlank
        $filterList = Concat($filterList, $this->menudRadhe->AdvancedSearch->toJson(), ","); // Field menudRadhe
        $filterList = Concat($filterList, $this->menudAktiv->AdvancedSearch->toJson(), ","); // Field menudAktiv
        $filterList = Concat($filterList, $this->menudAutor->AdvancedSearch->toJson(), ","); // Field menudAutor
        $filterList = Concat($filterList, $this->menudKrijuar->AdvancedSearch->toJson(), ","); // Field menudKrijuar
        $filterList = Concat($filterList, $this->menudAzhornuar->AdvancedSearch->toJson(), ","); // Field menudAzhornuar
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fmenu_dytesoresrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field menudID
        $this->menudID->AdvancedSearch->SearchValue = @$filter["x_menudID"];
        $this->menudID->AdvancedSearch->SearchOperator = @$filter["z_menudID"];
        $this->menudID->AdvancedSearch->SearchCondition = @$filter["v_menudID"];
        $this->menudID->AdvancedSearch->SearchValue2 = @$filter["y_menudID"];
        $this->menudID->AdvancedSearch->SearchOperator2 = @$filter["w_menudID"];
        $this->menudID->AdvancedSearch->save();

        // Field menudGjuha
        $this->menudGjuha->AdvancedSearch->SearchValue = @$filter["x_menudGjuha"];
        $this->menudGjuha->AdvancedSearch->SearchOperator = @$filter["z_menudGjuha"];
        $this->menudGjuha->AdvancedSearch->SearchCondition = @$filter["v_menudGjuha"];
        $this->menudGjuha->AdvancedSearch->SearchValue2 = @$filter["y_menudGjuha"];
        $this->menudGjuha->AdvancedSearch->SearchOperator2 = @$filter["w_menudGjuha"];
        $this->menudGjuha->AdvancedSearch->save();

        // Field menudKryesore
        $this->menudKryesore->AdvancedSearch->SearchValue = @$filter["x_menudKryesore"];
        $this->menudKryesore->AdvancedSearch->SearchOperator = @$filter["z_menudKryesore"];
        $this->menudKryesore->AdvancedSearch->SearchCondition = @$filter["v_menudKryesore"];
        $this->menudKryesore->AdvancedSearch->SearchValue2 = @$filter["y_menudKryesore"];
        $this->menudKryesore->AdvancedSearch->SearchOperator2 = @$filter["w_menudKryesore"];
        $this->menudKryesore->AdvancedSearch->save();

        // Field menudTitulli
        $this->menudTitulli->AdvancedSearch->SearchValue = @$filter["x_menudTitulli"];
        $this->menudTitulli->AdvancedSearch->SearchOperator = @$filter["z_menudTitulli"];
        $this->menudTitulli->AdvancedSearch->SearchCondition = @$filter["v_menudTitulli"];
        $this->menudTitulli->AdvancedSearch->SearchValue2 = @$filter["y_menudTitulli"];
        $this->menudTitulli->AdvancedSearch->SearchOperator2 = @$filter["w_menudTitulli"];
        $this->menudTitulli->AdvancedSearch->save();

        // Field menudUrl
        $this->menudUrl->AdvancedSearch->SearchValue = @$filter["x_menudUrl"];
        $this->menudUrl->AdvancedSearch->SearchOperator = @$filter["z_menudUrl"];
        $this->menudUrl->AdvancedSearch->SearchCondition = @$filter["v_menudUrl"];
        $this->menudUrl->AdvancedSearch->SearchValue2 = @$filter["y_menudUrl"];
        $this->menudUrl->AdvancedSearch->SearchOperator2 = @$filter["w_menudUrl"];
        $this->menudUrl->AdvancedSearch->save();

        // Field menudBlank
        $this->menudBlank->AdvancedSearch->SearchValue = @$filter["x_menudBlank"];
        $this->menudBlank->AdvancedSearch->SearchOperator = @$filter["z_menudBlank"];
        $this->menudBlank->AdvancedSearch->SearchCondition = @$filter["v_menudBlank"];
        $this->menudBlank->AdvancedSearch->SearchValue2 = @$filter["y_menudBlank"];
        $this->menudBlank->AdvancedSearch->SearchOperator2 = @$filter["w_menudBlank"];
        $this->menudBlank->AdvancedSearch->save();

        // Field menudRadhe
        $this->menudRadhe->AdvancedSearch->SearchValue = @$filter["x_menudRadhe"];
        $this->menudRadhe->AdvancedSearch->SearchOperator = @$filter["z_menudRadhe"];
        $this->menudRadhe->AdvancedSearch->SearchCondition = @$filter["v_menudRadhe"];
        $this->menudRadhe->AdvancedSearch->SearchValue2 = @$filter["y_menudRadhe"];
        $this->menudRadhe->AdvancedSearch->SearchOperator2 = @$filter["w_menudRadhe"];
        $this->menudRadhe->AdvancedSearch->save();

        // Field menudAktiv
        $this->menudAktiv->AdvancedSearch->SearchValue = @$filter["x_menudAktiv"];
        $this->menudAktiv->AdvancedSearch->SearchOperator = @$filter["z_menudAktiv"];
        $this->menudAktiv->AdvancedSearch->SearchCondition = @$filter["v_menudAktiv"];
        $this->menudAktiv->AdvancedSearch->SearchValue2 = @$filter["y_menudAktiv"];
        $this->menudAktiv->AdvancedSearch->SearchOperator2 = @$filter["w_menudAktiv"];
        $this->menudAktiv->AdvancedSearch->save();

        // Field menudAutor
        $this->menudAutor->AdvancedSearch->SearchValue = @$filter["x_menudAutor"];
        $this->menudAutor->AdvancedSearch->SearchOperator = @$filter["z_menudAutor"];
        $this->menudAutor->AdvancedSearch->SearchCondition = @$filter["v_menudAutor"];
        $this->menudAutor->AdvancedSearch->SearchValue2 = @$filter["y_menudAutor"];
        $this->menudAutor->AdvancedSearch->SearchOperator2 = @$filter["w_menudAutor"];
        $this->menudAutor->AdvancedSearch->save();

        // Field menudKrijuar
        $this->menudKrijuar->AdvancedSearch->SearchValue = @$filter["x_menudKrijuar"];
        $this->menudKrijuar->AdvancedSearch->SearchOperator = @$filter["z_menudKrijuar"];
        $this->menudKrijuar->AdvancedSearch->SearchCondition = @$filter["v_menudKrijuar"];
        $this->menudKrijuar->AdvancedSearch->SearchValue2 = @$filter["y_menudKrijuar"];
        $this->menudKrijuar->AdvancedSearch->SearchOperator2 = @$filter["w_menudKrijuar"];
        $this->menudKrijuar->AdvancedSearch->save();

        // Field menudAzhornuar
        $this->menudAzhornuar->AdvancedSearch->SearchValue = @$filter["x_menudAzhornuar"];
        $this->menudAzhornuar->AdvancedSearch->SearchOperator = @$filter["z_menudAzhornuar"];
        $this->menudAzhornuar->AdvancedSearch->SearchCondition = @$filter["v_menudAzhornuar"];
        $this->menudAzhornuar->AdvancedSearch->SearchValue2 = @$filter["y_menudAzhornuar"];
        $this->menudAzhornuar->AdvancedSearch->SearchOperator2 = @$filter["w_menudAzhornuar"];
        $this->menudAzhornuar->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->menudTitulli;
        $searchFlds[] = &$this->menudUrl;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->menudID, $ctrl); // menudID
            $this->updateSort($this->menudGjuha, $ctrl); // menudGjuha
            $this->updateSort($this->menudKryesore, $ctrl); // menudKryesore
            $this->updateSort($this->menudTitulli, $ctrl); // menudTitulli
            $this->updateSort($this->menudUrl, $ctrl); // menudUrl
            $this->updateSort($this->menudBlank, $ctrl); // menudBlank
            $this->updateSort($this->menudRadhe, $ctrl); // menudRadhe
            $this->updateSort($this->menudAktiv, $ctrl); // menudAktiv
            $this->updateSort($this->menudAutor, $ctrl); // menudAutor
            $this->updateSort($this->menudKrijuar, $ctrl); // menudKrijuar
            $this->updateSort($this->menudAzhornuar, $ctrl); // menudAzhornuar
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->menudID->setSort("");
                $this->menudGjuha->setSort("");
                $this->menudKryesore->setSort("");
                $this->menudTitulli->setSort("");
                $this->menudUrl->setSort("");
                $this->menudBlank->setSort("");
                $this->menudRadhe->setSort("");
                $this->menudAktiv->setSort("");
                $this->menudAutor->setSort("");
                $this->menudKrijuar->setSort("");
                $this->menudAzhornuar->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmenu_dytesorelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fmenu_dytesorelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->menudID->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("menudID", $this->createColumnOption("menudID"));
            $option->add("menudGjuha", $this->createColumnOption("menudGjuha"));
            $option->add("menudKryesore", $this->createColumnOption("menudKryesore"));
            $option->add("menudTitulli", $this->createColumnOption("menudTitulli"));
            $option->add("menudUrl", $this->createColumnOption("menudUrl"));
            $option->add("menudBlank", $this->createColumnOption("menudBlank"));
            $option->add("menudRadhe", $this->createColumnOption("menudRadhe"));
            $option->add("menudAktiv", $this->createColumnOption("menudAktiv"));
            $option->add("menudAutor", $this->createColumnOption("menudAutor"));
            $option->add("menudKrijuar", $this->createColumnOption("menudKrijuar"));
            $option->add("menudAzhornuar", $this->createColumnOption("menudAzhornuar"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmenu_dytesoresrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmenu_dytesoresrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fmenu_dytesorelist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fmenu_dytesorelist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fmenu_dytesoresrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
