    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("faqeID") ?? Route("faqeID")) !== null) {
                ...
                $this->RecKey["faqeID"] = $this->faqeID->QueryStringValue;
            } elseif (Post("faqeID") !== null) {
                $this->faqeID->setFormValue(Post("faqeID"));
                $this->RecKey["faqeID"] = $this->faqeID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->faqeID->setQueryStringValue($keyValue);
                $this->RecKey["faqeID"] = $this->faqeID->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "FaqeList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "FaqeList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "FaqeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
