 ...
 * Page class
 */
class PerdoruesitDelete extends Perdoruesit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PerdoruesitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PerdoruesitList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("PerdoruesitList"); // Return to list
            return;
        }
