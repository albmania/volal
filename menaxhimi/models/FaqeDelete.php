...
class FaqeDelete extends Faqe
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FaqeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FaqeList"); // Return to list
                return;
            }
        }
