 ...
 * Page class
 */
class Login extends Perdoruesit
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("perdoruesit", "perdoruesit", "username", "username", "username", "", 202, 255, -1, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-form-control");
        $this->Password = new DbField("perdoruesit", "perdoruesit", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("perdoruesit", "perdoruesit", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
