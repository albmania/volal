 ...
 * Page class
 */
class MakinaAdd extends Makina
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MakinaView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->makinaShtuar->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->makinaShtuar->Visible = false; // Disable update for API request
            } else {
                $this->makinaShtuar->setFormValue($val);
            }
    ...
    public function restoreFormValues()
    {
        ...
        $this->makinaShtuar->CurrentValue = $this->makinaShtuar->FormValue;
        $this->makinaShtuar->CurrentValue = UnFormatDateTime($this->makinaShtuar->CurrentValue, $this->makinaShtuar->formatPattern());
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // makinaKlienti
        $this->makinaKlienti->setDbValueDef($rsnew, $this->makinaKlienti->CurrentValue, 0, false);

        // makinaMarka
        $this->makinaMarka->setDbValueDef($rsnew, $this->makinaMarka->CurrentValue, "", strval($this->makinaMarka->CurrentValue ?? "") == "");

        // makinaModeli
        $this->makinaModeli->setDbValueDef($rsnew, $this->makinaModeli->CurrentValue, "", false);

        // makinaKarburanti
        $this->makinaKarburanti->setDbValueDef($rsnew, $this->makinaKarburanti->CurrentValue, "", strval($this->makinaKarburanti->CurrentValue ?? "") == "");

        // makinaMadhesiaMotorrit
        $this->makinaMadhesiaMotorrit->setDbValueDef($rsnew, $this->makinaMadhesiaMotorrit->CurrentValue, "", false);

        // makinaVitiProdhimit
        $this->makinaVitiProdhimit->setDbValueDef($rsnew, $this->makinaVitiProdhimit->CurrentValue, 0, false);

        // makinaNgjyra
        $this->makinaNgjyra->setDbValueDef($rsnew, $this->makinaNgjyra->CurrentValue, null, false);

        // makinaInfoShtese
        $this->makinaInfoShtese->setDbValueDef($rsnew, $this->makinaInfoShtese->CurrentValue, null, false);

        // makinaVitiRegAL
        $this->makinaVitiRegAL->setDbValueDef($rsnew, $this->makinaVitiRegAL->CurrentValue, null, false);

        // makinaTarga
        $this->makinaTarga->setDbValueDef($rsnew, $this->makinaTarga->CurrentValue, "", false);

        // makinaNrShasie
        $this->makinaNrShasie->setDbValueDef($rsnew, $this->makinaNrShasie->CurrentValue, null, false);

        // makinaPrejardhja
        $this->makinaPrejardhja->setDbValueDef($rsnew, $this->makinaPrejardhja->CurrentValue, null, false);

        // makinaShiturVOLAL
        $this->makinaShiturVOLAL->setDbValueDef($rsnew, $this->makinaShiturVOLAL->CurrentValue, "", strval($this->makinaShiturVOLAL->CurrentValue ?? "") == "");
        ...
        // makinaShtuar
        $this->makinaShtuar->CurrentValue = CurrentDateTime();
        $this->makinaShtuar->setDbValueDef($rsnew, $this->makinaShtuar->CurrentValue, CurrentDate());
