 ...
 * Page class
 */
class ServisSherbimeDelete extends ServisSherbime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServisSherbimeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServisSherbimeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ServisSherbimeList"); // Return to list
                return;
            }
        }
