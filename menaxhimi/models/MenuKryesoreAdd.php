 ...
 * Page class
 */
class MenuKryesoreAdd extends MenuKryesore
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MenuKryesoreAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MenuKryesoreView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->menukKrijuar->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->menukKrijuar->Visible = false; // Disable update for API request
            } else {
                $this->menukKrijuar->setFormValue($val);
            }
    ...
    public function restoreFormValues()
    {
        ...
        $this->menukKrijuar->CurrentValue = $this->menukKrijuar->FormValue;
        $this->menukKrijuar->CurrentValue = UnFormatDateTime($this->menukKrijuar->CurrentValue, $this->menukKrijuar->formatPattern());
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // menukGjuha
        $this->menukGjuha->setDbValueDef($rsnew, $this->menukGjuha->CurrentValue, "", false);

        // menukTitull
        $this->menukTitull->setDbValueDef($rsnew, $this->menukTitull->CurrentValue, "", false);

        // menukUrl
        $this->menukUrl->setDbValueDef($rsnew, $this->menukUrl->CurrentValue, "", false);

        // menukBlank
        $this->menukBlank->setDbValueDef($rsnew, $this->menukBlank->CurrentValue, "", strval($this->menukBlank->CurrentValue ?? "") == "");

        // menukRadhe
        $this->menukRadhe->setDbValueDef($rsnew, $this->menukRadhe->CurrentValue, 0, strval($this->menukRadhe->CurrentValue ?? "") == "");

        // menukAktiv
        $this->menukAktiv->setDbValueDef($rsnew, $this->menukAktiv->CurrentValue, null, strval($this->menukAktiv->CurrentValue ?? "") == "");
        ...
        // menukKrijuar
        $this->menukKrijuar->CurrentValue = CurrentDateTime();
        $this->menukKrijuar->setDbValueDef($rsnew, $this->menukKrijuar->CurrentValue, CurrentDate());
