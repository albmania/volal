 ...
 * Page class
 */
class ChangePassword extends Perdoruesit
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("perdoruesit", "perdoruesit", "opwd", "opwd", "opwd", "", 202, 255, -1, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->NewPassword = new DbField("perdoruesit", "perdoruesit", "npwd", "npwd", "npwd", "", 202, 255, -1, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->ConfirmPassword = new DbField("perdoruesit", "perdoruesit", "cpwd", "cpwd", "cpwd", "", 202, 255, -1, false, "", false, false, false);
