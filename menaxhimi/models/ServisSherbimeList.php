 ...
 * Page class
 */
class ServisSherbimeList extends ServisSherbime
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServisSherbimeList";
    ...
    public $FormName = "fservis_sherbimelist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "ServisSherbimeAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "ServisSherbimeDelete";
        $this->MultiUpdateUrl = "ServisSherbimeUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fservis_sherbimesrch");
        }
        $filterList = Concat($filterList, $this->servisSherbimID->AdvancedSearch->toJson(), ","); // Field servisSherbimID
        $filterList = Concat($filterList, $this->servisSherbimServisID->AdvancedSearch->toJson(), ","); // Field servisSherbimServisID
        $filterList = Concat($filterList, $this->servisSherbimSherbimi->AdvancedSearch->toJson(), ","); // Field servisSherbimSherbimi
        $filterList = Concat($filterList, $this->servisSherbimCmimi->AdvancedSearch->toJson(), ","); // Field servisSherbimCmimi
        $filterList = Concat($filterList, $this->servisSherbimShenim->AdvancedSearch->toJson(), ","); // Field servisSherbimShenim
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fservis_sherbimesrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field servisSherbimID
        $this->servisSherbimID->AdvancedSearch->SearchValue = @$filter["x_servisSherbimID"];
        $this->servisSherbimID->AdvancedSearch->SearchOperator = @$filter["z_servisSherbimID"];
        $this->servisSherbimID->AdvancedSearch->SearchCondition = @$filter["v_servisSherbimID"];
        $this->servisSherbimID->AdvancedSearch->SearchValue2 = @$filter["y_servisSherbimID"];
        $this->servisSherbimID->AdvancedSearch->SearchOperator2 = @$filter["w_servisSherbimID"];
        $this->servisSherbimID->AdvancedSearch->save();

        // Field servisSherbimServisID
        $this->servisSherbimServisID->AdvancedSearch->SearchValue = @$filter["x_servisSherbimServisID"];
        $this->servisSherbimServisID->AdvancedSearch->SearchOperator = @$filter["z_servisSherbimServisID"];
        $this->servisSherbimServisID->AdvancedSearch->SearchCondition = @$filter["v_servisSherbimServisID"];
        $this->servisSherbimServisID->AdvancedSearch->SearchValue2 = @$filter["y_servisSherbimServisID"];
        $this->servisSherbimServisID->AdvancedSearch->SearchOperator2 = @$filter["w_servisSherbimServisID"];
        $this->servisSherbimServisID->AdvancedSearch->save();

        // Field servisSherbimSherbimi
        $this->servisSherbimSherbimi->AdvancedSearch->SearchValue = @$filter["x_servisSherbimSherbimi"];
        $this->servisSherbimSherbimi->AdvancedSearch->SearchOperator = @$filter["z_servisSherbimSherbimi"];
        $this->servisSherbimSherbimi->AdvancedSearch->SearchCondition = @$filter["v_servisSherbimSherbimi"];
        $this->servisSherbimSherbimi->AdvancedSearch->SearchValue2 = @$filter["y_servisSherbimSherbimi"];
        $this->servisSherbimSherbimi->AdvancedSearch->SearchOperator2 = @$filter["w_servisSherbimSherbimi"];
        $this->servisSherbimSherbimi->AdvancedSearch->save();

        // Field servisSherbimCmimi
        $this->servisSherbimCmimi->AdvancedSearch->SearchValue = @$filter["x_servisSherbimCmimi"];
        $this->servisSherbimCmimi->AdvancedSearch->SearchOperator = @$filter["z_servisSherbimCmimi"];
        $this->servisSherbimCmimi->AdvancedSearch->SearchCondition = @$filter["v_servisSherbimCmimi"];
        $this->servisSherbimCmimi->AdvancedSearch->SearchValue2 = @$filter["y_servisSherbimCmimi"];
        $this->servisSherbimCmimi->AdvancedSearch->SearchOperator2 = @$filter["w_servisSherbimCmimi"];
        $this->servisSherbimCmimi->AdvancedSearch->save();

        // Field servisSherbimShenim
        $this->servisSherbimShenim->AdvancedSearch->SearchValue = @$filter["x_servisSherbimShenim"];
        $this->servisSherbimShenim->AdvancedSearch->SearchOperator = @$filter["z_servisSherbimShenim"];
        $this->servisSherbimShenim->AdvancedSearch->SearchCondition = @$filter["v_servisSherbimShenim"];
        $this->servisSherbimShenim->AdvancedSearch->SearchValue2 = @$filter["y_servisSherbimShenim"];
        $this->servisSherbimShenim->AdvancedSearch->SearchOperator2 = @$filter["w_servisSherbimShenim"];
        $this->servisSherbimShenim->AdvancedSearch->save();
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->servisSherbimShenim;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->servisSherbimID, $ctrl); // servisSherbimID
            $this->updateSort($this->servisSherbimServisID, $ctrl); // servisSherbimServisID
            $this->updateSort($this->servisSherbimSherbimi, $ctrl); // servisSherbimSherbimi
            $this->updateSort($this->servisSherbimCmimi, $ctrl); // servisSherbimCmimi
            $this->updateSort($this->servisSherbimShenim, $ctrl); // servisSherbimShenim
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->servisSherbimID->setSort("");
                $this->servisSherbimServisID->setSort("");
                $this->servisSherbimSherbimi->setSort("");
                $this->servisSherbimCmimi->setSort("");
                $this->servisSherbimShenim->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fservis_sherbimelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fservis_sherbimelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->servisSherbimID->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("servisSherbimID", $this->createColumnOption("servisSherbimID"));
            $option->add("servisSherbimServisID", $this->createColumnOption("servisSherbimServisID"));
            $option->add("servisSherbimSherbimi", $this->createColumnOption("servisSherbimSherbimi"));
            $option->add("servisSherbimCmimi", $this->createColumnOption("servisSherbimCmimi"));
            $option->add("servisSherbimShenim", $this->createColumnOption("servisSherbimShenim"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fservis_sherbimesrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fservis_sherbimesrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fservis_sherbimelist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->servisSherbimShenim->TooltipValue = "";
                    ...
                    $this->servisSherbimCmimi->Total = 0; // Initialize total
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fservis_sherbimelist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fservis_sherbimesrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
