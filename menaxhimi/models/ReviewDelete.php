 ...
 * Page class
 */
class ReviewDelete extends Review
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReviewDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ReviewList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ReviewList"); // Return to list
                return;
            }
        }
