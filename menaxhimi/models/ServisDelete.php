 ...
 * Page class
 */
class ServisDelete extends Servis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ServisDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ServisList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ServisList"); // Return to list
                return;
            }
        }
