...
// Page object
$MakinaShitjeAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { makina_shitje: currentTable } });
var currentForm, currentPageID;
var fmakina_shitjeadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fmakina_shitjeadd = new ew.Form("fmakina_shitjeadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fmakina_shitjeadd;

    // Add fields
    var fields = currentTable.fields;
    fmakina_shitjeadd.addFields([
        ...
        ["mshitjeKrijuar", [fields.mshitjeKrijuar.visible && fields.mshitjeKrijuar.required ? ew.Validators.required(fields.mshitjeKrijuar.caption) : null], fields.mshitjeKrijuar.isInvalid]
    ]);

    // Form_CustomValidate
    fmakina_shitjeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmakina_shitjeadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fmakina_shitjeadd.lists.mshitjeMarka = <?= $Page->mshitjeMarka->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeModeli = <?= $Page->mshitjeModeli->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeTipi = <?= $Page->mshitjeTipi->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeStruktura = <?= $Page->mshitjeStruktura->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeKarburant = <?= $Page->mshitjeKarburant->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeKambio = <?= $Page->mshitjeKambio->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeTargaAL = <?= $Page->mshitjeTargaAL->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeIndex = <?= $Page->mshitjeIndex->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjePromo = <?= $Page->mshitjePromo->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeAktiv = <?= $Page->mshitjeAktiv->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeShitur = <?= $Page->mshitjeShitur->toClientList($Page) ?>;
    fmakina_shitjeadd.lists.mshitjeAutori = <?= $Page->mshitjeAutori->toClientList($Page) ?>;
    loadjs.done("fmakina_shitjeadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fmakina_shitjeadd" id="fmakina_shitjeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php $Page->mshitjeMarka->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fmakina_shitjeadd_x_mshitjeMarka"
...
<script>
loadjs.ready("fmakina_shitjeadd", function() {
    var options = { name: "x_mshitjeMarka", selectId: "fmakina_shitjeadd_x_mshitjeMarka" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmakina_shitjeadd.lists.mshitjeMarka.lookupOptions.length) {
        options.data = { id: "x_mshitjeMarka", form: "fmakina_shitjeadd" };
    } else {
        options.ajax = { id: "x_mshitjeMarka", form: "fmakina_shitjeadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php $Page->mshitjeModeli->EditAttrs->prepend("onchange", "ew.updateOptions.call(this);"); ?>
    <select
        ...
        data-select2-id="fmakina_shitjeadd_x_mshitjeModeli"
        data-table="makina_shitje"
...
<script>
loadjs.ready("fmakina_shitjeadd", function() {
    var options = { name: "x_mshitjeModeli", selectId: "fmakina_shitjeadd_x_mshitjeModeli" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmakina_shitjeadd.lists.mshitjeModeli.lookupOptions.length) {
        options.data = { id: "x_mshitjeModeli", form: "fmakina_shitjeadd" };
    } else {
        options.ajax = { id: "x_mshitjeModeli", form: "fmakina_shitjeadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_makina_shitje_mshitjeTipi">
    <select
        ...
        data-select2-id="fmakina_shitjeadd_x_mshitjeTipi"
        data-table="makina_shitje"
...
<script>
loadjs.ready("fmakina_shitjeadd", function() {
    var options = { name: "x_mshitjeTipi", selectId: "fmakina_shitjeadd_x_mshitjeTipi" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmakina_shitjeadd.lists.mshitjeTipi.lookupOptions.length) {
        options.data = { id: "x_mshitjeTipi", form: "fmakina_shitjeadd" };
    } else {
        options.ajax = { id: "x_mshitjeTipi", form: "fmakina_shitjeadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<input type="hidden" name="fa_x_mshitjeFotografi" id= "fa_x_mshitjeFotografi" value="0">
...
<script>
loadjs.ready(["fmakina_shitjeadd", "editor"], function() {
    ew.createEditor("fmakina_shitjeadd", "x_mshitjePershkrimi", 35, 4, <?= $Page->mshitjePershkrimi->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
