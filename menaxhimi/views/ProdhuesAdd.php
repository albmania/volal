...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fprodhuesadd = new ew.Form("fprodhuesadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fprodhuesadd;

    // Add fields
    var fields = currentTable.fields;
    fprodhuesadd.addFields([
    ...
    // Form_CustomValidate
    fprodhuesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fprodhuesadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fprodhuesadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fprodhuesadd" id="fprodhuesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fa_x_prodhuesLogo" id= "fa_x_prodhuesLogo" value="0">
