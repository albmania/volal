...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fsherbimeadd = new ew.Form("fsherbimeadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fsherbimeadd;

    // Add fields
    var fields = currentTable.fields;
    fsherbimeadd.addFields([
    ...
    // Form_CustomValidate
    fsherbimeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fsherbimeadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fsherbimeadd.lists.sherbimeIndex = <?= $Page->sherbimeIndex->toClientList($Page) ?>;
    loadjs.done("fsherbimeadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fsherbimeadd" id="fsherbimeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" name="fa_x_sherbimeFoto" id= "fa_x_sherbimeFoto" value="0">
