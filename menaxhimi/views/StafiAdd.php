...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fstafiadd = new ew.Form("fstafiadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fstafiadd;
    ...
    // Form_CustomValidate
    fstafiadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fstafiadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("fstafiadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fstafiadd" id="fstafiadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fstafiadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fstafiadd", "x_stafiDatelindja", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
